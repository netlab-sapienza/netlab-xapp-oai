...
WORKDIR /root/
RUN   git clone --branch oranslice --single-branch https://github.com/wineslab/xapp-oai.git  \
      && cd xapp-oai/xapp_bs_connector \
      ...
      && sed -i 's/rte|12010|service-ricplt-e2term-rmr-alpha.ricplt:38000/rte|12010|service-ricplt-submgr-rmr.ricplt:4560/g' /root/xapp-oai/xapp_bs_connector/init/routes.txt
